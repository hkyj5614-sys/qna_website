...
function handleQuestionClick(questionId) {
    ...
    if (answersSection.style.display === 'none') {
        // 모든 답변 섹션 닫기
        document.querySelectorAll('.answers-section').forEach(section => {
            section.style.display = 'none';
        });
        // 모든 질문 아이템에서 active 클래스 제거
...
function displayQuestions() {
    ...
    questionsList.innerHTML = questions.map(question => {
        ...
        return `
            <div class="question-item" data-question-id="${question.id}" onclick="handleQuestionClick('${question.id}')">
                ...
                <div class="question-footer">
                    ...
                    <span class="answer-count">
                        <i class="fas fa-comments"></i> ${answers.length}개의 답변
                    </span>
                </div>
